 ...
 */
final class Version20250926123415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE burger_garniture (burger_id INT NOT NULL, garniture_id INT NOT NULL, INDEX IDX_2E7EE41817CE5090 (burger_id), INDEX IDX_2E7EE4184ADE7EE5 (garniture_id), PRIMARY KEY(burger_id, garniture_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE garniture (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE burger_garniture ADD CONSTRAINT FK_2E7EE41817CE5090 FOREIGN KEY (burger_id) REFERENCES burger (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE burger_garniture ADD CONSTRAINT FK_2E7EE4184ADE7EE5 FOREIGN KEY (garniture_id) REFERENCES garniture (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE burger_garniture DROP FOREIGN KEY FK_2E7EE41817CE5090');
        $this->addSql('ALTER TABLE burger_garniture DROP FOREIGN KEY FK_2E7EE4184ADE7EE5');
        ...
        $this->addSql('DROP TABLE burger_garniture');
